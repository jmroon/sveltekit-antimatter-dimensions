...
export const gameState = writable<GameState>(
  {
    ...
    dimensions: [
      ...
      { dimensionNumber: 5, displayName: '5st', cost: 10 ** 5, owned: 0, unlocked: true, multi: 1 },
      { dimensionNumber: 6, displayName: '6nd', cost: 10 ** 6, owned: 0, unlocked: true, multi: 1 },
      { dimensionNumber: 7, displayName: '7rd', cost: 10 ** 7, owned: 0, unlocked: true, multi: 1 },
      { dimensionNumber: 8, displayName: '8th', cost: 10 ** 8, owned: 0, unlocked: true, multi: 1 },
    ],
