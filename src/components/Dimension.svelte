...
<div class="flex flex-row w-[400px] font-bold text-gray-100 shadow-lg select-none rounded-xl bg-slate-800 ">
  ...
  <div class="flex flex-col overflow-hidden font-bold align-middle bg-slate-700 rounded-r-xl">
    <!-- Buy One -->
    <div
      class="flex flex-col justify-end w-full h-full group hover:text-gray-100 hover:cursor-pointer"
      on:click={() => buy(1)}
    >
    ...
    <!-- Buy Until -->
    <div class="flex flex-col justify-end w-full h-full group hover:text-gray-100 hover:cursor-pointer">
